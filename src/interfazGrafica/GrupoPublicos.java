...
public class GrupoPublicos extends Composite{
	private Group g;
	public GrupoPublicos(Composite c, int style) {
		super(c,style);
	...
	public static List<Fichero> fichsPubl(VentanaPrincipal vp ) {
